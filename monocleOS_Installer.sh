...
echo HOOKS=\(base systemd sd-plymouth keyboard autodetect sd-vconsole modconf block sd-encrypt lvm2 filesystems fsck shutdown\) | tee -a /etc/mkinitcpio.conf > /dev/null
